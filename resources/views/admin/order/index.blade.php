            ...
            <div class="modal-dialog modal-dialog-scrollable" role="document">
                <div class="modal-content text-dark">
                    ...
                    <div class="modal-body">
                        ...
                        <hr>
                        <div class="row">
                            <div class="col-3"><label class="fw-bold" for="payment_method">Phương thức thanh toán </label>
                            </div>
                            <div class="col-3">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 d-flex align-items-center">
                                ...
                                <a href="#" class="btn fw-bolder" id="save_total_payment" disabled><i data-feather="check"></i></a>
                            </div>
                        </div>
                        <hr>
                    </div>
